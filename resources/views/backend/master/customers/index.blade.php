    ...
    <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-0">
        <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
            <div class="page-title d-flex flex-column justify-content-center me-3">
                <h1 class="page-heading d-flex text-gray-900 fw-bold fs-3 flex-column justify-content-center my-0">Pelanggan</h1>
                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                    ...
                    <li class="breadcrumb-item"><i class="ki-outline ki-right fs-5 text-gray-700 mx-n1"></i></li>
                    <li class="breadcrumb-item text-gray-900">Pelanggan</li>
                </ul>
            </div>
        </div>
    </div>
                ...
                <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                    ...
                    <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                        <button type="button" class="btn btn-sm btn-primary" id="btn_tambah_data">
                            <i class="ki-outline ki-plus fs-2"></i> Tambah Pelanggan
                        </button>
                    </div>
                </div>
                <div class="card-body pt-0">
                    <table class="table align-middle table-row-dashed fs-6 gy-5 table-customers" id="table-customers">
                        <thead>
                            <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                                <th class="w-10px pe-2">No</th>
                                <th class="min-w-150px">Nama Pelanggan</th>
                                <th class="min-w-120px">No. HP</th>
                                <th class="min-w-100px">Status Member</th>
                                <th class="min-w-100px">Poin Loyalitas</th>
                ...
                <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                    <form id="FormTambahModalID" class="form">
                        ...
                        <div class="d-flex flex-column mb-7 fv-row">
                            ...
                            <input type="text" class="form-control form-control-solid" placeholder="Contoh: Budi Raharjo" name="name" />
                        ...
                        <div class="d-flex flex-column mb-7 fv-row">
                            ...
                            <input type="text" class="form-control form-control-solid" placeholder="Contoh: 08123456789" name="phone" />
                        ...
                        <div class="d-flex flex-column mb-7 fv-row">
                            ...
                            <select class="form-select form-select-solid" name="member_status">
                                ...
                                <option value="VIP">VIP (Diskon Member 10%)</option>
                            </select>
                            <span class="text-danger error-text member_status_error_add mt-2"></span>
                        </div>
                        <div class="d-flex flex-column mb-7 fv-row">
                            <label class="fs-6 fw-semibold mb-2">Alamat Pengantaran (Lengkap)</label>
                            <textarea class="form-control form-control-solid" rows="3" placeholder="Nama Jalan, Blok, RT/RW, Kecamatan" name="address"></textarea>
                        ...
                        <div class="row g-9 mb-7">
                            <div class="col-md-6 fv-row">
                                ...
                                <input type="text" class="form-control form-control-solid" placeholder="-6.2088" name="latitude" />
                            </div>
                            <div class="col-md-6 fv-row">
                                <label class="fs-6 fw-semibold mb-2">Longitude (GPS)</label>
                                <input type="text" class="form-control form-control-solid" placeholder="106.8456" name="longitude" />
                            </div>
                        </div>
        ...
        <script>
            $(document).ready(function() {
                ...
                $('body').on('click', '.btn-edit', function() {
                    let id = $(this).data('id');
                    $.get("{{ url('admin') }}/customers/" + id + "/edit", function(res) {
